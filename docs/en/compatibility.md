...
| Android WebView/mobile browser                       | Usually WASM                             | Account for the roughly 136 MiB FP32 download and memory peak            |
